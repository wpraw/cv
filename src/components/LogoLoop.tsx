              ...
              <>
                <div
                  ...
                  className={cx(
                    ...
                    "w-[clamp(24px,12%,120px)]",
                    "bg-[linear-gradient(to_right,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))_0%,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))_20%,rgba(0,0,0,0)_100%)]",
                    "rounded-l-4xl"
                  )}
                />
                <div
                  ...
                  className={cx(
                    ...
                    "w-[clamp(24px,12%,120px)]",
                    "bg-[linear-gradient(to_left,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))_0%,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))_20%,rgba(0,0,0,0)_100%)]",
                    "rounded-r-4xl"
                  )}
                />
              </>
