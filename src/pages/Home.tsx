    ...
    <div className="bg-linear-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
      <nav className="container absolute mx-auto px-6 py-6 flex justify-between items-end-safe w-full z-20">
        <div className="flex gap-6">
          <Link
            to="/kontakt"
            className="hover:text-purple-400 transition-colors cursor-pointer p-2"
          >
            Kontakt
          </Link>
          <Link
      ...
      <section className="container mx-auto px-6 text-center">
        ...
        <div className="max-w-4xl mx-auto border-3 rounded-4xl border-(--laser-flow-color) py-20 bg-[linear-gradient(to_right,rgba(30,41,59,0.9)_0%,rgba(51,65,85,0.95)_50%,rgba(30,41,59,0.9)_100%)] backdrop-blur-sm shadow-[inset_0_0_80px_rgba(0,0,0,0.5)]">
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          <div className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-lg border border-slate-700">
            ...
            <p className="text-gray-300 leading-relaxed">
              Rozwijam aplikacje webowe wykorzystując najnowsze technologie.
              Specjalizuję się w tworzeniu responsywnych interfejsów użytkownika
              oraz skalowalnych backendów.
            </p>
          </div>
          <div className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-lg border border-slate-700">
            <h3 className="text-2xl font-semibold mb-2 text-purple-400">
            ...
            <p className="text-gray-300 leading-relaxed">
              Wspieram społeczność programistów poprzez udział w projektach open
              source i dzielenie się wiedzą.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        <div className="max-w-2xl mx-auto bg-linear-to-r from-purple-600/20 to-pink-600/20 p-12 rounded-2xl border border-purple-500/30">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Jestem otwarty na nowe projekty i możliwości współpracy. Skontaktuj
            się ze mną!
          </p>
          <Link
            to="/kontakt"
      ...
      <footer className="container mx-auto px-6 py-8 border-t border-slate-700">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400">
            © {new Date().getFullYear()} Wojciech Prawdzik
          </p>
          <div className="flex gap-6">
            <a
              href="https://github.com/wojciechprawdzik"
